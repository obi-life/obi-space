      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-4 max-w-7xl mx-auto">
          {images.map((image, index) => (
            <div
              key={index}
              className={`group relative overflow-hidden rounded-2xl shadow-[var(--shadow-subtle)] hover:shadow-[var(--shadow-warm)] transition-all duration-500 h-64 ${image.span} animate-slide-up`}
